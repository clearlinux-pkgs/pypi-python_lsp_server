...
Source0  : https://files.pythonhosted.org/packages/59/c5/fdb678be01f90450cb3c785eba8fbdd80361156c31da96137eb5c31f9a66/python-lsp-server-1.7.1.tar.gz
...
%prep
%setup -q -n python-lsp-server-1.7.1
cd %{_builddir}/python-lsp-server-1.7.1
pushd ..
cp -a python-lsp-server-1.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674056317

...
Source0  : https://files.pythonhosted.org/packages/5e/58/835ce6e458317324a6c8a1fdd273659bd508d4c7967adca520e3d0b587f6/python-lsp-server-1.11.0.tar.gz
...
%prep
%setup -q -n python-lsp-server-1.11.0
cd %{_builddir}/python-lsp-server-1.11.0
pushd ..
cp -a python-lsp-server-1.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711840608

...
Source0  : https://files.pythonhosted.org/packages/b0/2a/b61699d8a1eb4adc23647e44ac4c94ccc4f5c9ddb477e3eb54a48342e666/python-lsp-server-1.7.0.tar.gz
...
%prep
%setup -q -n python-lsp-server-1.7.0
cd %{_builddir}/python-lsp-server-1.7.0
pushd ..
cp -a python-lsp-server-1.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672418001

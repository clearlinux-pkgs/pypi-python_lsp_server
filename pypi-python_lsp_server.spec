...
Source0  : https://files.pythonhosted.org/packages/6c/9f/4a3a6cc6e982eca3dfad39fdcaf48dcdc5a020f38dfe973e4487765e0048/python-lsp-server-1.10.0.tar.gz
...
%prep
%setup -q -n python-lsp-server-1.10.0
cd %{_builddir}/python-lsp-server-1.10.0
pushd ..
cp -a python-lsp-server-1.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705866072

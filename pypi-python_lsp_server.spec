...
%prep
%setup -q -n python-lsp-server-1.4.1
cd %{_builddir}/python-lsp-server-1.4.1
pushd ..
cp -a python-lsp-server-1.4.1 buildavx2
popd
...
cp %{_builddir}/python-lsp-server-1.4.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-python_lsp_server/c0a4218ed5c81a62f45a9cc14735457e71102cee
